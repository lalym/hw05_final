# Generated by Django 2.2.6 on 2021-04-30 23:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Здесь напишите текст комментария', verbose_name='Текст комментария')),
                ('created', models.DateTimeField(auto_now_add=True, help_text='Укажите дату комментария', verbose_name='Дата комментария')),
